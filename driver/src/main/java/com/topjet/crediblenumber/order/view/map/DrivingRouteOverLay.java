...
public class DrivingRouteOverLay extends RouteOverlay {
    ...
    private int getcolor(String status) {
        ...
        return mContext.getResources().getColor(R.color.route_color);
...
//        }
    ...
    private BitmapDescriptor getThroughPointBitDes() {
        return BitmapDescriptorFactory.fromResource(R.drawable.bg_transparent); // 中途图标是透明的
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        return BitmapDescriptorFactory.fromResource(R.drawable.abcdefghijklmnopqrstuvwxyz);
    }
    /**
