...
public class ClipZoomImageView extends ImageView implements
    ...
    public void onGlobalLayout() {
        if (once) {
            ...
            float scale = 1.0f;
            if (dw < viewWidth - mHorizontalPadding * 2
                    && dh > viewHeight - mVerticalPadding * 2) {
                scale = (viewWidth * 1.0f - mHorizontalPadding * 2) / dw;
            }

            if (dh < viewHeight - mVerticalPadding * 2
                    && dw > viewWidth - mHorizontalPadding * 2) {
                scale = (viewHeight * 1.0f - mVerticalPadding * 2) / dh;
            }

            if (dw < viewWidth - mHorizontalPadding * 2
                    && dh < viewHeight - mVerticalPadding * 2) {
                float scaleW = (viewWidth * 1.0f - mHorizontalPadding * 2) / dw;
                float scaleH = (viewHeight * 1.0f - mVerticalPadding * 2) / dh;
            ...
            mScaleMatrix.postTranslate((viewWidth - dw) / 2, (viewHeight - dh) / 2);
    ...
    public Bitmap clip() {
         ...
         * y must be >= 0 at android.graphics.Bitmap.checkXYSign
         *
         * 需要给mHorizontalPadding和mVerticalPadding赋初始值
         */
