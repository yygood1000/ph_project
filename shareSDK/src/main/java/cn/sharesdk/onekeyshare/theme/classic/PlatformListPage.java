...
import cn.sharesdk.wxapi.CancleTitle;
import cn.sharesdk.wxapi.CancleTitle.OnCancleButtonClickListener;
...
public class PlatformListPage extends PlatformListFakeActivity implements View.OnClickListener {
	...
	// cancleTitle
	private CancleTitle cancleTitle;
	// cancel button(不用这个Button了,使用cancleTitle进行点击退出)
...
//		btnCancel.setOnClickListener(this);
	...
	private void initPageView() {
		...
		flPage.setBackgroundDrawable(new ColorDrawable(0x33000000));
		...
		//cancleTitle
		cancleTitle = new CancleTitle(getContext());
		cancleTitle.setOnCancleButtonClickListener(new OnCancleButtonClickListener() {
