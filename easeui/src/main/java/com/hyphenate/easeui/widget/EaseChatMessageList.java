...
public class EaseChatMessageList extends RelativeLayout{
    ...
    protected void parseStyle(Context context, AttributeSet attrs) {
        ...
        builder.showAvatar(ta.getBoolean(R.styleable.EaseChatMessageList_msgListShowUserAvatar, true))
                ...
                .myBubbleBg(ta.getResourceId(R.styleable.EaseChatMessageList_msgListMyBubbleBackground,-1))
                .otherBuddleBg(ta.getResourceId(R.styleable.EaseChatMessageList_msgListOtherBubbleBackground,-1));
	 ...
	 * @param res
	 */
	public void setOtherBuddleBg(int res){
		itemStyle.setOtherBubbleBg(res);
	}
    ...
    public interface MessageListItemClickListener{
	    ...
	    void onImageMessageClick(String messageid);
	}
    ...
    public ArrayList<ImageModel> getPhotoPathList(){
        return messageAdapter.getPhotoPathList();
    }
