...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        tvPressToSpeak = findViewById(R.id.tv_press_to_speak);
...
//        edittext_layout.setBackgroundResource(R.drawable.ease_input_bar_bg_normal);
        ...
        if(CMemoryData.isDriver()){
            faceChecked.setImageResource(R.drawable.ease_chatting_biaoqing_btn_enable);
            buttonSend.setBackgroundResource(R.drawable.ease_chat_send_btn_driver);
        }else{
            faceChecked.setImageResource(R.drawable.ease_chatting_biaoqing_btn_enable_shipper);
            buttonSend.setBackgroundResource(R.drawable.ease_chat_send_btn_shipper);
        }
