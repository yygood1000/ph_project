...
public final class EaseUI {
    ...
    private HistorySaveProvider historySaveProvider;
    ...
    public HistorySaveProvider getHistorySaveProvider() {
        return historySaveProvider;
    }

    public void setHistorySaveProvider(HistorySaveProvider historySaveProvider) {
        this.historySaveProvider = historySaveProvider;
    }
     ...
     * 保存历史聊天记录的回调
     */
    public interface HistorySaveProvider{
        List<EMMessage> saveHistoryMessage(HistoryMessageResponse response);
    }
