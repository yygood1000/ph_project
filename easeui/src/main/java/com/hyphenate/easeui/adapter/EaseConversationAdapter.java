...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.list_itease_layout.setBackgroundResource(R.color.white);
        ...
        Logger.d("conversation消息 "+conversation.getAllMsgCount());
        if (conversation.getAllMsgCount() != 0) {
            ...
            if(lastMessage.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_EMPTY, false)){
                // 空数据不显示
            ...
            if(!TextUtils.isEmpty(CPersisData.getUserID()) && CPersisData.getUserID().equals(lastMessage.getTo())){
                draftMessage = SPUtils.getString(lastMessage.getFrom(),null);
            }else {
                draftMessage = SPUtils.getString(lastMessage.getTo(),null);
            }
            Logger.d("草稿消息 "+lastMessage.getFrom()+" "+lastMessage.getTo()+" "+draftMessage+" ");

            if(!TextUtils.isEmpty(draftMessage)){
                holder.draft.setVisibility(View.VISIBLE);
                holder.message.setText(draftMessage);
            }else{
                holder.draft.setVisibility(View.GONE);
            }
//            holder.time.setText(DateUtils.getTimestampString(new Date(lastMessage.getMsgTime())));
            holder.time.setText(EaseTimeUtils.showTime(String.valueOf(lastMessage.getMsgTime())));
        ...
        //set line
        Logger.d("TTT",getCount()-1+"getCount");
